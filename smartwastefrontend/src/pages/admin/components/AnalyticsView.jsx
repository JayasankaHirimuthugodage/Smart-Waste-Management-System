...
const AnalyticsView = () => {
  ...
  const analyticsDashboards = [
    {
      ...
      description:
        "Monitor collection efficiency, worker performance, and route optimization",
      icon: TrendingUp,
      color: "#4CBB17",
    ...
    },
    {
      ...
      description:
        "Track recycling rates, waste composition, and sustainability metrics",
      icon: Recycle,
      color: "#3b82f6",
    ...
    },
    {
      ...
      description:
        "Analyze carbon footprint, waste reduction, and environmental KPIs",
      icon: Leaf,
      color: "#10b981",
  ...
  return (
    <>
      ...
      <div className="mb-6">
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900">Let's Analyse</h2>
